...
public class CMac {
    ...
    public static void main(String[] args) {
        ...
        byte[] cbcKey = hexStrtoByte("606162636465666768696A6B6C6D6E6F");
        /*
         * {
         * (byte)0x2b,
         * (byte)0x7e,
        ...
        byte[] text = hexStrtoByte(
                "003815163A2222B000B1000000002E0C0114FF98FDF620C194358C2657BBE12B917D0BE572050000000000000000000000000000000000000000000000000000");
        /*
         * {
         * 
         * (byte)0x6b,
        ...
        for (int i = 0; i < cmac.getMac().length; i++) {
            System.out.printf("%02X", cmac.getMac()[i]);
        }
