...
# Step 1: Defining and visualising the graph
...
# Step 2: Defining the reward the system for the bot
MATRIX_SIZE = 11
...
# Step 3: defining some utility functions to be used in the training
...
# Step 4: Training and evaluating the bot using the Q-Matrix
scores = []
for i in range(1000):
...
# Step 5: Defining and visualizing the new graph with the environmental clues
...
# Step 6: Defining some utility functions for the training process
Q = np.matrix(np.zeros([MATRIX_SIZE, MATRIX_SIZE]))
...
# Step 7: Visualising the Environmental matrices
scores = []
for i in range(1000):
	current_state = np.random.randint(0, int(Q.shape[0]))
	available_action = available_actions(current_state)
